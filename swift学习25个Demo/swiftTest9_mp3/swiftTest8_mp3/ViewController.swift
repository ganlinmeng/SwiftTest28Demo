...
class ViewController: UIViewController {
    ...
    func setUpUI() {
        playBtn.frame = CGRect.init(x: 10, y: 100, width: 100, height: 100)
        playBtn.backgroundColor = UIColor.red
        view.addSubview(playBtn)
        playBtn.addTarget(self, action: #selector(playMusicButtonDidTouch), for: .touchUpInside)
        
    }
   @objc func playMusicButtonDidTouch(_ sender : AnyObject) {
        ...
        let color3 = UIColor(red: 0, green: 1, blue: 0, alpha: 0.4).cgColor as CGColor
